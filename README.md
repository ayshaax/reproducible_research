...
- **Repository**: a repository (or repo) is essentially a folder that contains all your files and their revision history. GitHub gives you the option to make your repositories public or private.
- **Commit**: commits refer to changes in the repository files that have been recorded as part of its history. You can think of it as a snapshot of your repository at a given time.
...
- **Pull**: to update your cloned repo to the most recent version, you can pull the contents of the remote repository. This is needed when changes are made to the remote repo after you've cloned it, and you wish to continue work with the latest commits.
- **Push**: pushing allows you to update the remote repo with your local commits. However, it will only push commits from the current branch you have checked out, so make sure you know in which branch you are.
